            ...
            <div className='h-[88vh] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white flex'>
                <div className='lg:w-3/5 z-20 flex flex-col justify-center'>
                    <div className='mx-auto w-4/5 lg:text-left text-center'>
                        ...
                        <Link href="/login" className='lg:hidden inline-block ml-5 hover:bg-inherit bg-[#fffeee] hover:text-white text-purple-600 text-3xl w-4/5 rounded-full mt-5 hover:border-2 p-4 font-semibold font-mono z-10'>SHOP NOW</Link>

                    </div>
                </div>
                <div className='absolute lg:relative lg:w-2/5 flex justify-center w-full h-[88vh]'>
