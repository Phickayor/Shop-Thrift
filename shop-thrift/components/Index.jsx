...
function Index() {
    ...
    return (
        <>
            <div className='h-[85vh] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white flex'>
                <div className='lg:w-3/5 z-20 flex flex-col justify-center'>
                    <div className='mx-auto w-4/5 lg:text-left text-center'>
                        ...
                        <button className='lg:hidden inline-block ml-5 hover:bg-inherit bg-[#fffeee] hover:text-white text-purple-600 text-3xl w-4/5 rounded-full mt-5 hover:border-2 p-4 font-semibold font-mono'>SHOP NOW</button>

                    </div>
                </div>
                <div className='absolute lg:relative lg:w-2/5 flex justify-center w-full h-[85vh]'>
                    <Image src={Avatar} className='object-cover h-full z-10 lg:opacity-90 opacity-40' />
                </div>
            </div>
        </>
    )
